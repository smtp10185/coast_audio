...
class _FakeAudioDeviceContext_0 extends _i1.SmartFake
  ...
  _FakeAudioDeviceContext_0(Object parent, Invocation parentInvocation)
...
class _FakePlaybackDeviceWriteResult_2 extends _i1.SmartFake
  ...
  _FakePlaybackDeviceWriteResult_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockPlaybackDevice extends _i1.Mock implements _i2.PlaybackDevice {
  ...
  @override
  _i2.AudioDeviceContext get context =>
      (super.noSuchMethod(
  ...
  @override
  int get bufferFrameSize =>
      (super.noSuchMethod(Invocation.getter(#bufferFrameSize), returnValue: 0)
          as int);
  ...
  set volume(double? value) => super.noSuchMethod(
    Invocation.setter(#volume, value),
    returnValueForMissingStub: null,
  );

  @override
  _i2.AudioDeviceState get state =>
      (super.noSuchMethod(
  ...
  @override
  int get resourceId =>
      (super.noSuchMethod(Invocation.getter(#resourceId), returnValue: 0)
          as int);
  ...
  _i2.PlaybackDeviceWriteResult write(_i2.AudioBuffer? buffer) =>
      (super.noSuchMethod(
            Invocation.method(#write, [buffer]),
  ...
  void stop({bool? clearBuffer = true}) => super.noSuchMethod(
    Invocation.method(#stop, [], {#clearBuffer: clearBuffer}),
    returnValueForMissingStub: null,
  );
  ...
  void throwIfDisposed() => super.noSuchMethod(
    Invocation.method(#throwIfDisposed, []),
    returnValueForMissingStub: null,
  );
  ...
  void setResourceFinalizer<T>(void Function()? onFinalize) =>
      super.noSuchMethod(
        Invocation.method(#setResourceFinalizer, [onFinalize]),
        returnValueForMissingStub: null,
      );

  @override
  void clearResourceFinalizer() => super.noSuchMethod(
    Invocation.method(#clearResourceFinalizer, []),
    returnValueForMissingStub: null,
  );
}
