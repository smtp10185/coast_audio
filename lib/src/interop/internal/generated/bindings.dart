...
final class UnnamedStruct17 extends ffi.Struct {
  ...
  external ffi.Pointer<ma_uint8> pHeapData;
}
...
final class UnnamedUnion19 extends ffi.Union {
  ...
  external UnnamedStruct54 as_send_port;

  external UnnamedStruct55 as_capability;

  external UnnamedStruct56 as_array;

  external UnnamedStruct57 as_typed_data;

  external UnnamedStruct58 as_external_typed_data;

  external UnnamedStruct59 as_native_pointer;
}
...
final class UnnamedUnion20 extends ffi.Union {
  external UnnamedStruct60 encoded;

  external UnnamedStruct61 decoded;

  external UnnamedStruct62 decodedPaged;
}
...
final class ma_engine_node extends ffi.Struct {
  ...
  external UnnamedStruct63 fadeSettings;
...
final class UnnamedStruct63 extends ffi.Struct {
